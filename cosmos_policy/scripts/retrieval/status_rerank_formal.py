...
def main():
    ...
    parser.add_argument("--root", type=Path, default=Path(
        "/mnt4/cyh/ReCAP_qwen_visual_align/results/rerank_top30_formal_20260910"))
    args = parser.parse_args()
    report = {"checked_at": datetime.datetime.now().astimezone().isoformat(), "groups": {}}
    for group in ("e2_r2", "e2_r8", "e8_r2", "e8_r8"):
        ...
        for seed in (42, 52, 62, 72, 82):
            ...
            if traces:
                ...
                row.update(current_episode=last["episode"] + 1, current_step=last["step"],
                           ...
                           candidate_count=last["candidate_count"], rerank_count=last.get("rerank_count"),
                           coarse_seconds=last.get("coarse_retrieval_seconds"), rerank_seconds=last.get("rerank_seconds"),
